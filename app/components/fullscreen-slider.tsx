      ...
      {isSliderOpen && (
        <div className="fixed top-0 left-0 z-10 flex h-full w-full items-center justify-center bg-neutral-900 bg-opacity-80">
          <Cross1Icon
            ...
            cursor-pointer rounded-full bg-royalPurple p-2 text-3xl text-neutral-100 
        sm:right-8 sm:transition-transform sm:duration-300 sm:hover:translate-y-1"
          ...
          <ChevronLeftIcon
            className="absolute left-2 top-1/2 h-12 w-12 -translate-y-1/2 cursor-pointer rounded-full 
        bg-royalPurple p-2 text-neutral-100 sm:left-16 sm:transition-transform sm:duration-300 sm:hover:translate-y-[calc(-50%+4px)]"
            onClick={() => prevImage()}
          />
          <ChevronRightIcon
            className="absolute right-2 top-1/2 h-12 w-12 -translate-y-1/2 cursor-pointer rounded-full 
        bg-royalPurple p-2 text-neutral-100 sm:right-16 sm:transition-transform sm:duration-300 sm:hover:translate-y-[calc(-50%+4px)]"
            onClick={() => nextImage()}
          />
        </div>
      )}
